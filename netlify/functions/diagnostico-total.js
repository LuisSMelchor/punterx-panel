...
// ========================== AISLAMIENTO TOTAL ==========================
// Evita CUALQUIER redeclaración top-level. Si el runtime evaluara el archivo 2+ veces,
// solo asignamos el handler una vez y listo.
if (!globalThis.__PX_DIAG_MODULE__) {
  globalThis.__PX_DIAG_MODULE__ = (function makeModule() {
    ...
    async function getCreateClient() {
      ...
      try {
        const mod = await import('@supabase/supabase-js'); // CJS → ESM dynamic import
        ...
        return null; // ← no romper la función
      }
    }
...
// Asigna el handler único, sin redeclarar identificadores top-level.
exports.handler = globalThis.__PX_DIAG_MODULE__.handler;
